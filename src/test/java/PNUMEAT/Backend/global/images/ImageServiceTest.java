...
//        when(multipartFile.getInputStream()).thenReturn(new ByteArrayInputStream("dummy data".getBytes()));
//
//        doReturn(null).when(s3Client).putObject(any(PutObjectRequest.class), any(RequestBody.class));
//
//        String s3Url = imageService.imageUpload(multipartFile);
//
//        assertNotNull(s3Url);
...
//    void 이미지_업데이트_성공() throws IOException {
//        String s3Url = "https://test-bucket.s3.test-region.amazonaws.com/test-image.jpg";
//
//        when(multipartFile.isEmpty()).thenReturn(false);
//        when(multipartFile.getOriginalFilename()).thenReturn("updated-image.jpg");
//        when(multipartFile.getInputStream()).thenReturn(new ByteArrayInputStream("dummy data".getBytes()));
//
//        doReturn(null).when(s3Client).putObject(any(PutObjectRequest.class), any(RequestBody.class));
//
//        String updatedS3Url = imageService.imageUpdate(multipartFile, s3Url);
//
//        assertNotNull(updatedS3Url);
//        assertTrue(updatedS3Url.contains("test-bucket"));
//        verify(s3Client, times(1)).putObject(any(PutObjectRequest.class), any(RequestBody.class));
//    }
//}
